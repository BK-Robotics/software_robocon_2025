...
private:
    ...
    void handle_base_control_service(const std::shared_ptr<robot_interfaces::srv::BaseControl::Request> request,
                                     std::shared_ptr<robot_interfaces::srv::BaseControl::Response> response); ///< Xử lý lệnh điều khiển cơ sở từ service
    ...
    rclcpp::Service<robot_interfaces::srv::BaseControl>::SharedPtr service_base_control_;
