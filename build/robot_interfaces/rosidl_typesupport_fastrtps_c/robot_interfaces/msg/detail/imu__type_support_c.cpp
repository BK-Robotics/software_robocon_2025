...
#include "robot_interfaces/msg/detail/imu__rosidl_typesupport_fastrtps_c.h"
...
using _IMU__ros_msg_type = robot_interfaces__msg__IMU;
...
size_t get_serialized_size_robot_interfaces__msg__IMU(
  const void * untyped_ros_message,
...
static uint32_t _IMU__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_interfaces__msg__IMU(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_interfaces
size_t max_serialized_size_robot_interfaces__msg__IMU(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces__msg__IMU;
    is_plain =
      (
...
static size_t _IMU__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_interfaces__msg__IMU(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_interfaces, msg, IMU)() {
