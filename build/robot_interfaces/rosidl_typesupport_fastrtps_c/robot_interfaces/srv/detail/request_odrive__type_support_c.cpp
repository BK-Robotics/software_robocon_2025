...
#include "robot_interfaces/srv/detail/request_odrive__rosidl_typesupport_fastrtps_c.h"
...
using _RequestOdrive_Request__ros_msg_type = robot_interfaces__srv__RequestOdrive_Request;
...
size_t get_serialized_size_robot_interfaces__srv__RequestOdrive_Request(
  const void * untyped_ros_message,
...
static uint32_t _RequestOdrive_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_interfaces__srv__RequestOdrive_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_interfaces
size_t max_serialized_size_robot_interfaces__srv__RequestOdrive_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces__srv__RequestOdrive_Request;
    is_plain =
      (
...
static size_t _RequestOdrive_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_interfaces__srv__RequestOdrive_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_interfaces, srv, RequestOdrive_Request)() {
...
using _RequestOdrive_Response__ros_msg_type = robot_interfaces__srv__RequestOdrive_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_interfaces
size_t get_serialized_size_robot_interfaces__srv__RequestOdrive_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RequestOdrive_Response__ros_msg_type * ros_message = static_cast<const _RequestOdrive_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_interfaces__srv__RequestOdrive_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_interfaces
size_t max_serialized_size_robot_interfaces__srv__RequestOdrive_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robot_interfaces__srv__RequestOdrive_Response;
    is_plain =
      (
...
static size_t _RequestOdrive_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_interfaces__srv__RequestOdrive_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_interfaces, srv, RequestOdrive_Response)() {
...
// already included above
// #include "robot_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "robot_interfaces/srv/request_odrive.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_interfaces, srv, RequestOdrive)() {
